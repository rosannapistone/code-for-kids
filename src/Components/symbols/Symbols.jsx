  ...
  return (    
    <div className="symbols-container">
      ...
      {show ? (<div className="symbols">
        ...
        <a href="https://www.w3schools.com/css/default.asp" target="_blank" rel="noreferrer">Läs mer om CSS</a>
        </div>
        <div className="html">
        ...
        <a href="https://www.w3schools.com/html/default.asp" target="_blank" rel="noreferrer">Läs mer om HTML</a>
        </div>
        {showJS === true ? (
          ...
          <a href="https://www.w3schools.com/js/default.asp" target="_blank" rel="noreferrer">Läs mer om JavaScript</a>
          </div> 
        )
      : null}
